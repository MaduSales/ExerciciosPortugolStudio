programa {
  funcao inicio() {
    ...
    se (imc < 16.9){
      escreva("O seu IMC é "+imc+". Muito abaixo do peso.")
    }
    senao se (imc > 17 e imc < 18.5){
      escreva("O seu IMC é "+imc+". Abaixo do peso.")
    }
    ...
    senao se (imc > 30 e imc < 34.9){
      escreva("O seu IMC é "+imc+". Obesidade grau I.")
    }
    senao se (imc > 35 e imc < 40){
      escreva("O seu IMC é "+imc+".Obesidade grau II.")
    }
    senao {
      escreva("O seu IMC é "+imc+".Obesidade grau III.")
    }
  }
}
